...
class TvDatafeed:
    ...
    def get_hist(
        ...
        Args:
            ...
            divAdj (bool, optional). if True return values adjusted for dividends (like selecting adj at the bottom right of the chart)
        Returns:
            pd.Dataframe: dataframe with sohlcv as columns
        """
        adj = '"dividends"' if divAdj else '"splits"'
